...
$pdateWeekName = array("شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه");
...
function pdate($format, $timestamp = "")
{
    ...
    while ($i < $lenghFormat)
    {
        ...
        switch ($par)
        {
            ...
            case 't':
                $result .= (isKabise($pYear) and $pMonth == 12) ? 30:
                $MonthDays[$pMonth];
                break;
        ...
        if ($par == "%")
        {
            ...
            switch ($type)
            {
                ...
                case 'j':
                    ...
                    $result .= ($dayinM < 10) ? "00" . $dayinM:
                    (($dayinM < 100) ? "0" . $dayinM : $dayinM);
                    break;
