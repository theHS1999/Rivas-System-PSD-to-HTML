            ...
            if(data){
                if(data=='no'){
                   ...
                   // var iran_percent=0;
                    ...
                    var rest_price =rest*m['price'] / 100;

                    var iran = 100 - contract_f;
                    var iran_price = iran* m['price'] / 100;
                    var franshiz= 100-iran;
                    var franshiz_price=m['price'] * franshiz / 100;
                    if(iran_price>=rest_price){
                        document.getElementById("ip" + input_id).innerHTML = '%' + rest;
                        document.getElementById("iran_percent" + input_id).value = rest_price;
                        document.getElementById("pp" + input_id).innerHTML = '%0';
                        document.getElementById("franshiz" + input_id).value = 0;
                    }else {
                        document.getElementById("ip" + input_id).innerHTML = '%' + iran;
                        document.getElementById("iran_percent" + input_id).value = iran_price;
                        document.getElementById("pp" + input_id).innerHTML = '%'+ franshiz;
                        document.getElementById("franshiz" + input_id).value = franshiz_price;
                    }
                    /*if (m['iran_percent'] != 0) {
...
function calculate_sum(){
    ...
    daroha.forEach(function(a){
        ...
        if(parseInt(document.getElementById("med_spec"+a.id).value)>0 && parseFloat(document.getElementById("franshiz"+a.id).value)>=0 && parseFloat(document.getElementById("iran_percent"+a.id).value)>=0){
            specs=parseFloat(document.getElementById("franshiz"+a.id).value)+parseFloat(document.getElementById("iran_percent"+a.id).value)+specs;
            }
        });
    ...
    total_insured=presc_insured+left_oevr;
