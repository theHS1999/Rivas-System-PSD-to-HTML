...
@section('content')
    <ol class="breadcrumb" >
        <li class="active bold">ویرایش تعهد</li>
    ...
    <div class="col-sm-4 col-sm-offset-4" >
        ...
        <div class="form-group col-xs-12">
            <label><span class="glyphicon glyphicon-asterisk star"></span>نام تعهد:</label>

            {!!Form::text('name',$commit->name,['class'=>'form-control','required'])!!}
        </div>
